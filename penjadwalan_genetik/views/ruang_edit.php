...
<div class="content">
   ...
   <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url();?>web/wilayah">Wilayah Kerja</a> <span class="divider">/</span></li>
      ...
      <div class="row-fluid">
        ...
        <form id="tab" method="POST" >
            ...
            <div class="form-actions">
              ...
              <a href="<?php echo base_url() .'web/wilayah'; ?>"><button type="button" class="btn">Cancel</button></a>
            </div>
        </form>
