...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Penjadwalan - <?php echo $page_title;?></title>
               ...
               <body class="">
                  ...
                  <div class="navbar">
                     <div class="navbar-inner">
                        <a class="brand" href="#"><span class="first">Penjadwalan</span></a>
                     </div>
                  </div>
                  <div class="sidebar-nav" style="padding-top: 5px">
                     ...
                     <ul id="content-menu" class="nav nav-list collapse in">                        
						<li><a href="<?php echo base_url()?>web/pekerja"><i class="icon-user"></i>Pekerja</a></li>   
						<li><a href="<?php echo base_url()?>web/posisi"><i class="icon-book"></i>Posisi</a></li>
						<li><a href="<?php echo base_url();?>web/pengampu"><i class="icon-th-list"></i>Pengampu</a></li>
						<li><a href="<?php echo base_url()?>web/wilayah"><i class="icon-home"></i>Wilayah</a></li>
